...
class JobProgress(BaseModel):
    ...
    current: int = Field(description="The current step")
...
class TaskDocument(BaseModel):
    ...
    cloud_run_job_name: str = Field(description="The Cloud Run job name. With the format 'projects/{project_id}/locations/{location}/jobs/{job_id}'")
